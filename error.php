...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<p class="left">
			...
			Because i beleive in free speech  and freedom of information i decided to do a little digging into the  undernet. What i learnt is disturbing especially since i have confirmed it by infilitrating the ROMANIANS, i have learned that a  coalition of chinese black hats from the Red Hacker Alliance, and  ROMANIAN AND SOUTH KOREAN SKIDDIES are preparing to launch a 5 million node malaysian  botnet denial of service attack against doxbin AND its  affiliates.
		</p>
		...
		<p><a href="index.php">Go to the archive</a>
		<p class="contact">
