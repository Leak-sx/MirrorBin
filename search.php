...
<a href="postdox.php">Post dox</a> <a href="index.php">Back to the archive</a><br />
<?php
	...
	// $my_root = /path/to/your/document/root;
				...
				while($file = @readdir($handle))
				{
					...
					{ // Alle Dateien gemaess Endungen $s_files
						...
						if($do)
						{
							...
							{
								/* Orginal CODE
								echo "<a href=\"index.php?dox=$link_title\" target=\"_blank\" class=\"result\">$count_hits.  $link_title</a><br>"; // Ausgabe des Links
								echo "<br>";
								*/
								...
								if ($mirror == True) {
									$link_titleClean = str_replace("-mirror-", "", $link_title);
								} else {
									$link_titleClean = $link_title;
								}
								...
								echo ". ";
								echo "<a href=\"index.php?dox=$link_title\" target=\"_blank\" alt=\"$link_titleClean\">$link_titleClean</a>"; // Ausgabe des Links
...
<html>
	...
	<body>
		<?php
			//Table like archive
			echo '<table><thead><tr>';
			echo '<th class="doxcols">Name</th> <th class="doxcols">Mirror</th> <th class="doxcols">Date</th> <th class="doxcols">Time</th> <th class="doxcols">Filesize</th>';
			...
			//back to archive
			echo '<div class="doxheader"><a href="index.php">Back to archive</a><br/></div>';
